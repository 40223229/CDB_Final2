...
class Hello(object):
    ...
    <h2>姓名：許家瑜</h2>
     ...
     <h3><a href="drawspur">個人繪製齒輪</a><br />
       <h3> <a href="drawspur2">三人繪製齒輪</a><br />
    ...
    <html>
    <head>
    <h1>40223229許家瑜 繪製齒輪1</h1>
    <h1>40123135陳俊安 繪製齒輪2</h1>
    <h1>40023154顏邦智 繪製齒輪3</h1>
    <meta http-equiv="content-type" content="text/html;charset=utf-8">
    <br /><a href="index">返回首頁</a><br />
    <!-- 載入 brython.js -->
    <script type="text/javascript" src="/static/Brython3.1.1-20150328-091302/brython.js"></script>
    ...
    ctx.save()
    # translate to the origin of third gear
    ctx.translate(500+ rp_g2+ rp_g3+ rp_g4+ rp_g5,500+rp_g1+rp_g2+ rp_g3+ rp_g4)
    # rotate to engage
    ctx.rotate( -pi/2-pi/n_g5+(pi/2+pi/n_g4)*n_g4/n_g5-(-pi/2+pi/n_g3)*n_g3/n_g5+(pi/2+pi/n_g2)*n_g2/n_g5)
    # put it back
    ctx.translate(-(500+ rp_g2+ rp_g3+ rp_g4+ rp_g5),-(500+rp_g1+rp_g2+ rp_g3+ rp_g4))
    spur.Spur(ctx).Gear(500+ rp_g2+ rp_g3+ rp_g4+ rp_g5,500+rp_g1+rp_g2+ rp_g3+ rp_g4,rp_g5, n_g5, pa, "green")
    ctx.restore()

    # 將第6齒輪逆時鐘轉 90 度之後, 再多轉一齒, 以便與第1齒輪進行囓合
    ctx.save()
    # translate to the origin of third gear
    ctx.translate(500+ rp_g2+ rp_g3+ rp_g4+ rp_g5,500+rp_g1+rp_g2+ rp_g3+ rp_g4+ rp_g5 + rp_g6)
    # rotate to engage
    ctx.rotate(-pi/n_g6+(3*pi/2+pi/n_g5)*n_g5/n_g6-(pi/2+pi/n_g4)*n_g4/n_g6+(-pi/2+pi/n_g3)*n_g3/n_g6-(pi/2+pi/n_g2)*n_g2/n_g6)
    # put it back
    ctx.translate(-(500+ rp_g2+ rp_g3+ rp_g4+ rp_g5),-(500+rp_g1+rp_g2+ rp_g3+ rp_g4+ rp_g5 + rp_g6))
    spur.Spur(ctx).Gear(500+ rp_g2+ rp_g3+ rp_g4+ rp_g5,500+rp_g1+rp_g2+ rp_g3+ rp_g4+ rp_g5 + rp_g6,rp_g6, n_g6, pa, "black")
    ctx.restore()

    </script>
    <canvas id="plotarea" width="2500" height="2800"></canvas>
    </body>
    </html>
    '''
